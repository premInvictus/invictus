...
export class AuthenticationService {
  ...
  login(
    ...
    if (loginSource == "support") {
      ...
      return this.http.post(
        environment.apiSisUrl + "/users/supportAuthenticate",
        {
          username: username,
          password: password,
          device_id: device_id,
      ...
      let pheaders = new HttpHeaders(hOptions);
      return this.http.post(
        environment.apiSisUrl + "/users/authenticate",
        {
          username: username,
          password: password,
          device_id: device_id,
      ...
      console.log(
        "this.loaderService.getUserPrefix()",
        this.loaderService.getUserPrefix()
      );
      if (this.loaderService.getUserPrefix()) {
        return this.http.post(environment.apiSisUrl + "/users/authenticate", {
          username: username,
          password: password,
          device_id: device_id,
          type: type,
  ...
  getOTP(value: any) {
    ...
    if (this.loaderService.getUserPrefix()) {
      return this.http.post(
        environment.apiAxiomUrl + "/users/forgot_password_mobile",
        value
      );
    } else {
      return this.http.post(
  ...
  sendMail(value: any) {
    ...
    if (this.loaderService.getUserPrefix()) {
      return this.http.post(
        environment.apiAxiomUrl + "/users/forgot_password_email",
        value
      );
    } else {
      return this.http.post(
  ...
  validateOTP(value: any) {
    ...
    if (this.loaderService.getUserPrefix()) {
      return this.http.post(
        environment.apiAxiomUrl + "/users/validate_otp",
        value
      );
    } else {
      return this.http.post(
  ...
  resetPassword(value: any) {
    ...
    if (this.loaderService.getUserPrefix()) {
      return this.http.post(
        environment.apiAxiomUrl + "/users/change_password",
        value
      );
    } else {
      return this.http.post(
  ...
  getUserProjectDetail(value: any) {
    ...
    return this.http.post(
      environment.apiSisUrl + "/users/getUserProject",
      inputJson,
      { headers: headers }
    );
  }
