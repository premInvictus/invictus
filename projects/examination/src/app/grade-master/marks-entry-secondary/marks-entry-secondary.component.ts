...
@Component({
  selector: 'app-marks-entry-secondary',
  templateUrl: './marks-entry-secondary.component.html',
  styleUrls: ['./marks-entry-secondary.component.css']
})
export class MarksEntrySecondaryComponent implements OnInit {
