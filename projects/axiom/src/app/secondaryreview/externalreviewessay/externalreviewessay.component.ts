...
import { ReviewElement } from '../externalreviewessay/externalreviewessay.model';
...
@Component({
		selector: 'app-externalreviewessay',
		templateUrl: './externalreviewessay.component.html',
		styleUrls: ['./externalreviewessay.component.css']
})
export class ExternalreviewessayComponent implements OnInit, AfterViewInit, AfterViewChecked {
