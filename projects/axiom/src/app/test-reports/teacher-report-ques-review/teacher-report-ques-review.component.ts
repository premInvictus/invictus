...
@Component({
	selector: 'app-teacher-report-ques-review',
	templateUrl: './teacher-report-ques-review.component.html',
	styleUrls: ['./teacher-report-ques-review.component.css']
})
export class TeacherReportQuesReviewComponent implements OnInit {
	...
	doubleIntegerArray1: any[] = [{id: '0'}, {id: '1'}, {id: '2'}, {id: '3'}, {id: '4'}, {id: '5'}, {id: '6'}, {id: '7'}, {id: '8'}, {id: '9'}];
	// tslint:disable-next-line:max-line-length
	doubleIntegerArray2: any[] = [{id: '0'}, {id: '1'}, {id: '2'}, {id: '3'}, {id: '4'}, {id: '5'}, {id: '6'}, {id: '7'}, {id: '8'}, {id: '9'}];
	upperRowValue: any;
	lowerRowValue: any;
	digitValue: any;
							...
							if (result2 && result2.status === 'ok') {
								...
								this.qelementService.getQuestionPaper({qp_id: this.examDetail.es_qp_id}).subscribe(
									(result3: any) => {
										if (result3 && result3.status === 'ok') {
											this.questionpaperDetail = result3.data[0];
								...
								for (const qitem of this.questionpaperDetail.qlist) {
									this.questionIdArray.push(qitem.qpq_qus_id);
											...
											(result6: any) => {
												if (result6 && result6.status === 'ok') {
													this.questionsArrayResult = result6.data;
													// this.questionsArray=this.questionsArrayResult;
 ...
 groupBy(list, fn) {
	...
	{name: 'D',
	value: [{index: 12, id: 'P'}, {index: 13, id: 'Q'}, {index: 14, id: 'R'}, {index: 15, id: 'S'}]}];
	this.matrixMatch45Array = [{name: 'A',
	value: [{index: 0, id: 'P'}, {index: 1, id: 'Q'}, {index: 2, id: 'R'}, {index: 3, id: 'S'}, {index: 4, id: 'T'}]},
	{name: 'B',
	value: [{index: 5, id: 'P'}, {index: 6, id: 'Q'}, {index: 7, id: 'R'}, {index: 8, id: 'S'}, {index: 9, id: 'T'}]},
	{name: 'C',
	...
	this.trueFalseArray = [
		{name: 'True', value: '0'},
		{name: 'False', value: '1'}];
		this.singleIntegerArray = [{id: '0'}, {id: '1'}, {id: '2'}, {id: '3'}, {id: '4'}, {id: '5'}, {id: '6'}, {id: '7'}, {id: '8'}, {id: '9'}];
		this.doubleIntegerArray1 = [{id: '0'}, {id: '1'}, {id: '2'}, {id: '3'}, {id: '4'}, {id: '5'}, {id: '6'}, {id: '7'}, {id: '8'}, {id: '9'}];
		this.doubleIntegerArray2 = [{id: '0'}, {id: '1'}, {id: '2'}, {id: '3'}, {id: '4'}, {id: '5'}, {id: '6'}, {id: '7'}, {id: '8'}, {id: '9'}];
		this.subjectiveInputAnswer = '';
