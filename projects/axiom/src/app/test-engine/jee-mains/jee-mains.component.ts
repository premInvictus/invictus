...
export class JeeMainsComponent implements OnInit {
	...
	midButtonClick() {
		...
		if (x.style.display === 'block') {
			...
			document.getElementById('left-ques-container').setAttribute('class', 'custom-mid-left-ques-container-jee-mains');
			document.getElementById('right-ques-container').setAttribute('class', 'custom-mid-right-ques-container-jee-mains');
			document.getElementById('midnavbutton').setAttribute('class', 'mid-nav-button-jee-mains');
