...
@Component({
	selector: 'app-admin-overall-performance',
	templateUrl: './admin-overall-performance.component.html',
	styleUrls: ['./admin-overall-performance.component.css']
})
export class AdminOverallPerformanceComponent implements OnInit, OnChanges {
	...
	ngOnChanges() {
		if (this.reportFlag || this.tabFlag) {
			this.currentusername = this.currentUser.au_full_name;
			this.currentUserClass = this.currentUser.class_name;
			this.currentUserSec = this.currentUser.sec_name;
			this.currentAdmission = this.currentUser.au_login_id;
