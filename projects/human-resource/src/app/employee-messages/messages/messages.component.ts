...
export class MessagesComponent implements OnInit {
	...
	getMessages() {
		...
		var inputJson = { 'status.status_name' : 'approved', '$or': [{ 'msg_to.login_id': this.currentUser && this.currentUser['login_id'] }, { 'msg_thread.msg_to.login_id': this.currentUser && this.currentUser['login_id'] },{ 'msg_from': this.currentUser && this.currentUser['login_id'] }] };
