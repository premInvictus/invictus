...
@Component({
	selector: 'app-idcard-style3',
	templateUrl: './idcard-style3.component.html',
	styleUrls: ['./idcard-style3.component.scss']
})
export class IdcardStyle3Component implements OnInit, OnChanges {
