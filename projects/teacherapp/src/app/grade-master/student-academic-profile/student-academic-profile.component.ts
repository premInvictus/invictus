...
@Component({
  ...
  providers: [ ProcessTypeExamService ]
})
export class StudentAcademicProfileComponent implements OnInit {
  ...
  isDisabled = true;
  backOnly = false;
  defaultImageSource = 'https://s3.ap-south-1.amazonaws.com/files.invictusdigisoft.com/images/other.png';
  classArray = [];
  sectionArray = [];
  houseArray = [];
  ...
  ngOnInit() {
    this.buildForm();
    if (this.studentRouteMoveStoreService.getProcessRouteType()) {
      this.processType = this.studentRouteMoveStoreService.getProcessRouteType();
    } else {
      this.processType = '4';
    }
  ...
  buildForm() {
    this.studentDetailsForm = this.formBuild.group({
      auProfileImage: '',
      au_enrollment_id: '',
      au_login_id: '',
      au_full_name: '',
        ...
        .subscribe((result: any) => {
          if (result && result.status === 'ok') {
            ...
            if (result && result.data && result.data[0]) {
              ...
              this.getStudentAttendence(this.previousLoginId);
              this.getGlobalSetting();
              if (this.gender === 'M') {
                this.defaultImageSource = 'https://s3.ap-south-1.amazonaws.com/files.invictusdigisoft.com/images/man.png';
              } else if (this.gender === 'F') {
                this.defaultImageSource = 'https://s3.ap-south-1.amazonaws.com/files.invictusdigisoft.com/images/girl.png';
              } else {
                this.defaultImageSource = 'https://s3.ap-south-1.amazonaws.com/files.invictusdigisoft.com/images/other.png';
              }
              ...
              if (Number(this.processType) === 4) {
                this.previousAdmissionNumber = this.studentDetails.em_admission_no;
                if (this.nextFlag) {
                ...
                this.previousAdmissionNumber = this.studentDetails.em_regd_no;
                if (this.nextFlag) {
                  this.next.emit(this.studentLoginId);
                ...
                this.previousAdmissionNumber = this.studentDetails.em_provisional_admission_no;
                if (this.nextFlag) {
                  this.next.emit(this.studentLoginId);
                  this.next2.emit(
                    this.studentDetails.em_provisional_admission_no
                ...
                this.previousAdmissionNumber = this.studentDetails.em_enq_no;
                if (this.nextFlag) {
                  this.next.emit(this.studentLoginId);
                ...
                this.previousAdmissionNumber = this.studentDetails.em_alumini_no;
                if (this.nextFlag) {
                  this.next.emit(this.studentLoginId);
            ...
            this.studentDetailsForm.patchValue({
              auProfileImage: this.studentDetails.auProfileImage
                ? this.studentDetails.auProfileImage
            ...
            this.nextId(this.previousAdmissionNumber);
  ...
  getStudentAttendence(au_login_id) {
    this.firstGauge = false;
    this.present = 0;
    this.absent = 0;
    this.attendancePercentage = 0;
    this.savedSettingsArray
    this.examService.getStudentAttendence({ login_id: au_login_id }).subscribe((result: any) => {
      if (result && result.status === 'ok') {
