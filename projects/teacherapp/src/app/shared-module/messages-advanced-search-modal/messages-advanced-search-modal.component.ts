...
@Component({
  selector: 'app-messages-advanced-search-modal',
  templateUrl: './messages-advanced-search-modal.component.html',
  styleUrls: ['./messages-advanced-search-modal.component.css']
})
export class MessagesAdvancedSearchModalComponent implements OnInit {
  dialogRef: MatDialogRef<MessagesAdvancedSearchModalComponent>;
