...
export class AddModalComponent implements OnInit {
	...
	addForm: FormGroup;
	constructor(private dialog: MatDialog, private FormBuilder: FormBuilder, private sisService: SisService, private notify: CommonAPIService) { }
	...
	buildRemarkForm(){
		this.generalRemarkForm = this.FormBuilder.group({
			era_type: 'general',
			era_doj: new Date(),
			era_aut_id: '',
			era_ar_id: '',
