...
@Component({
  selector: 'app-bulk-wallet-transaction',
  templateUrl: './bulk-wallet-transaction.component.html',
  styleUrls: ['./bulk-wallet-transaction.component.css']
})
export class BulkWalletTransactionComponent implements OnInit {
