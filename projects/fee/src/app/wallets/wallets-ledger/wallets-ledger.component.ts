...
export class WalletsLedgerComponent implements OnInit {
  ...
  displayedColumns: string[] = ['w_rpt_no', 'w_transaction_date', 'w_amount', 'w_amount_type', 'w_pay_id', 'w_cheque_no', 'w_cheque_date', 'w_bnk_id', 'w_branch', 'w_transaction_id', 'w_remarks'];
