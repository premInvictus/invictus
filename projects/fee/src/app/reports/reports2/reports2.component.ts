...
export class Reports2Component implements OnInit {
	...
	feeReportArray: any[] = [
		...
		{
			report_id: '22',
			report_name: 'Fee Receipt Summary',
			report_image:
				'/assets/images/Fee Reports/deleted_fee_transaction.png',
			main_text_class: 'text-left inline-flex margin-top-5 icon-spacer',
			report_main_image_class: '',
		...
		{
			report_id: '23',
			report_name: 'Cancel Fee Receipts',
			report_image:
				'/assets/images/Fee Reports/deleted_fee_transaction.png',
			main_text_class: 'text-left inline-flex margin-top-5 icon-spacer',
			report_main_image_class: '',
	...
	isExistUserAccessMenu(actionT) {
		...
		if (actionT === '21') {
			return this.CommonAPIService.isExistUserAccessMenu('823');
			// return true;
		}
		if (actionT === '22') {
			return this.CommonAPIService.isExistUserAccessMenu('824');
			// return true;
		}
		if (actionT === '23') {
			return this.CommonAPIService.isExistUserAccessMenu('871');
			return true;
		}
	}
}
