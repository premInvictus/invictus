...
@Component({
	selector: 'app-prov-admission-setup',
	templateUrl: './prov-admission-setup.component.html',
	styleUrls: ['./prov-admission-setup.component.scss']
})
export class ProvAdmissionSetupComponent implements OnInit {
	...
	ngOnInit() {
		this.getTabsIndexes();
		this.formsTab = this.studentFormConfigService.getForm('provisional');
	...
	getTabsIndexes() {
		this.tabIdArray = this.studentFormConfigService.getTabsIndex('provisional');
	}
