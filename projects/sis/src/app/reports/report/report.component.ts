...
export class ReportComponent implements OnInit {
	...
	feeReportArray: any[] = [
		...
		{
			report_id: '11',
			report_name: 'Admission Process Report',
			report_image:
				'/assets/images/Fee Reports/missing_fee_invoice.png',
			main_text_class: 'text-left inline-flex margin-top-5 icon-spacer',
			report_main_image_class: '',
		...
		{
			report_id: '16',
			report_name: 'Utilization Report',
			report_image:
				'/assets/images/Fee Reports/missing_fee_invoice.png',
			main_text_class: 'text-left inline-flex margin-top-5 icon-spacer',
			report_main_image_class: '',
		...
		{
			report_id: '17',
			report_name: 'Promotional Report',
			report_image:
				'/assets/images/Fee Reports/missing_fee_invoice.png',
			main_text_class: 'text-left inline-flex margin-top-5 icon-spacer',
			report_main_image_class: '',
	...
	isExistUserAccessMenu(actionT) {
		...
		if (actionT === '13') {
			return this.CommonAPIService.isExistUserAccessMenu('860');
			// return true;
		}
		if (actionT === '14') {
		...
		if (actionT === '15') {
			return this.CommonAPIService.isExistUserAccessMenu('820');
			// return true;
		}
		if (actionT === '16') {
