...
@Component({
	selector: 'app-alumini-theme-two',
	templateUrl: './alumini-theme-two.component.html',
	styleUrls: ['./alumini-theme-two.component.scss']
})
export class AluminiThemeTwoComponent implements OnInit, OnDestroy {
