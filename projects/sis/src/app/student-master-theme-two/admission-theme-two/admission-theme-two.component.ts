...
@Component({
	selector: 'app-admission-theme-two',
	templateUrl: './admission-theme-two.component.html',
	styleUrls: ['./admission-theme-two.component.scss']
})
export class AdmissionThemeTwoComponent implements OnInit, OnDestroy {
