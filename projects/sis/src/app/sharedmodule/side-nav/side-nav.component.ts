...
export class SideNavComponent implements OnInit, OnChanges {
	...
	moveToDashboard() {
		this.router.navigate(['/sis/school']);
	}
	...
	getUserAccessMenu() {
		...
		if (Number(this.currentUser && this.currentUser.role_id) === 1) {
			const param: any = {};
		...
		} else if (Number(this.currentUser && this.currentUser.role_id) === 2) {
			const param: any = {};
			param.login_id = this.currentUser.login_id;
			param.role_id = this.currentUser.role_id;
			param.pro_id = '2';
		...
		} else if (Number(this.currentUser && this.currentUser.role_id) === 3) {
			const param: any = {};
			param.login_id = this.currentUser.login_id;
			param.role_id = this.currentUser.role_id;
			param.pro_id = '2';
		...
		} else if (Number(this.currentUser && this.currentUser.role_id) === 4) {
