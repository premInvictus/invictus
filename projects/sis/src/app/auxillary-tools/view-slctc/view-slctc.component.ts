...
@Component({
	selector: 'app-view-slctc',
	templateUrl: './view-slctc.component.html',
	styleUrls: ['./view-slctc.component.scss']
})
export class ViewSlctcComponent implements OnInit {
	...
	previewImage(imgArray) {
		this.dialogRef2 = this.dialog.open(PreviewDocumentComponent, {
			data: {
				imageArray: { imgName: imgArray.tcd_doc_link }
			},
			height: '70vh',
			width: '70vh'
		});
