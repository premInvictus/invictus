...
export class QuestionNoOnGoingModalComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		private dialog: MatDialog,
		private socketService: SocketService,
		public dialogRef2: MatDialogRef<QuestionNoOnGoingModalComponent>
	) { }
	...
	openQuesDialog(): void {
		const dialogRef2 = this.dialog.open(QuestionNoOnGoingModalComponent, {
			width: '380px',
		});
