...
@Component({
  selector: 'app-advanced-search-modal-3',
  templateUrl: './advanced-search-modal-3.component.html',
  styleUrls: ['./advanced-search-modal-3.component.css']
})
export class AdvancedSearchModalComponentThree implements OnInit {
  dialogRef: MatDialogRef<AdvancedSearchModalComponentThree>;
    ...
    this.filterArray = [
      {
        ...
        name: 'Department',
        type: 'text',
        placeholder: 'Search item by Department'
      },
      {
        id: 'created_by',
        name: 'Created By',
        type: 'text',
        placeholder: 'Search item by Created By'
      },
      {
        id: 'vendor',
        name: 'Vendor',
        type: 'text',
        placeholder: 'Search item by Vendor By'
      },
      {
        id: 'item_location',
        name: 'Location',
