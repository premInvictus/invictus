...
@Component({
  selector: 'app-advanced-search-modal-2',
  templateUrl: './advanced-search-modal-2.component.html',
  styleUrls: ['./advanced-search-modal-2.component.css']
})
export class AdvancedSearchModalComponentTwo implements OnInit {
  dialogRef: MatDialogRef<AdvancedSearchModalComponentTwo>;
