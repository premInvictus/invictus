...
@Component({
  selector: 'app-advanced-search-modal-4',
  templateUrl: './advanced-search-modal-4.component.html',
  styleUrls: ['./advanced-search-modal-4.component.css']
})
export class AdvancedSearchModalComponentFour implements OnInit {
  dialogRef: MatDialogRef<AdvancedSearchModalComponentFour>;
