...
const routes: Routes = [
  {
    ...
    children: [
      { path: "", component: AdminDashboardComponent },
      {
        path: "setup",
        loadChildren:
          "projects/admin-app/src/app/acsetup/acsetup.module#AcsetupModule",
      },
      {
        path: "questionbank",
        loadChildren:
          "projects/admin-app/src/app/questionbank/questionbank.module#QuestionbankModule",
      },
      {
        path: "question",
        loadChildren:
          "projects/admin-app/src/app/question/question.module#QuestionModule",
      },
      {
        path: "template",
        loadChildren:
          "projects/admin-app/src/app/questiontemplate/questiontemplate.module#QuestiontemplateModule",
      },
      {
        path: "questionpaper",
        loadChildren:
          "projects/admin-app/src/app/questionpaper/questionpaper.module#QuestionpaperModule",
      },
      {
        path: "question_paper_setup",
        loadChildren:
          "projects/admin-app/src/app/question-paper-setup/question-paper-setup.module#QuestionPaperSetupModule",
      },
      {
        path: "review",
        loadChildren:
